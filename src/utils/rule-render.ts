...
const TELEGRAM_CHANNEL_NAMES: Record<string, string> = {
  ...
  "-1003606859699": "Notifikasi Output Desainer Outlet",
  "-1003844846249": "Notifikasi Output Krah Manset",
  ...
  "-1003511011323": "Notifikasi Output Cutting",
  "-1003824650534": "Notifikasi Marketing",
  "-4879898572": "Notifikasi Sablon / DTF",
  "-1003747828848": "Notifikasi HR",
  "-1003866293253": "Notifikasi Customer Care",
  "-4884206656": "Notifikasi Log Developer",
  "-1003673007441": "Notifikasi Output Finishing",
