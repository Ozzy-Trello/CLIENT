  ...
  it("menghasilkan pesan persis seperti contoh yang disepakati", () => {
    const message = buildQuoteMessage({
      ...
      rates: [
        ...
        { courierName: "POS", service: "POS KARGO", cost: 48500, etd: "7-14 day" },
        { courierName: "JNE", service: "JTR", cost: 55000, etd: "3 day" },
        { courierName: "Sentral Cargo", service: "GOKIL", cost: 60000, etd: "5-7 day" },
        { courierName: "JNE", service: "REG", cost: 64000, etd: "2 day" },
        { courierName: "POS", service: "Pos Reguler", cost: 64000, etd: "2 day" },
        { courierName: "J&T", service: "EZ", cost: 66000, etd: null },
    ...
    expect(message).toBe(
      [
        ...
        "   Estimasi 2-4 day",
        "2. POS POS KARGO — Rp48.500",
        "   Estimasi 7-14 day",
        "3. JNE JTR — Rp55.000",
        "   Estimasi 3 day",
        "4. Sentral Cargo GOKIL — Rp60.000",
        "   Estimasi 5-7 day",
        "5. JNE REG — Rp64.000",
        "   Estimasi 2 day",
        "6. POS Pos Reguler — Rp64.000",
        "   Estimasi 2 day",
        "7. J&T EZ — Rp66.000",
        "   Estimasi -",
