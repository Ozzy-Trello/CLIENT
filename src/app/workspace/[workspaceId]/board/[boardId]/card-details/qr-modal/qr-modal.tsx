  ...
  return (
    ...
    >
      <style jsx global>{`
        ...
        .qr-appear {
          animation: qrAppear 0.5s cubic-bezier(0.26, 0.86, 0.44, 0.985)
            forwards;
        }
      ...
      <div className="flex flex-col items-center py-4">
        <div
          className={`flex items-center justify-center gap-3 mb-6 qr-fade-in ${
            fadeIn ? "active" : ""
          }`}
        >
          ...
          <Tooltip title="Download QR Code">
            <Button
              ...
              className={`flex items-center justify-center rounded-full p-2 ${
                generating ? "opacity-50" : "hover:bg-gray-100"
              }`}
              type="text"
            >
        ...
        <div
          ref={qrContainerRef}
          className={`relative bg-white p-6 rounded-xl shadow-lg border border-gray-100 qr-container ${
            fadeIn ? "active" : ""
          }`}
        >
          {generating ? (
            <div
              className="flex flex-col items-center justify-center spin-appear"
              style={{ width: 260, height: 260 }}
            >
              <Spin size="large" />
              <Typography.Text className="text-gray-500 mt-4">
                Generating QR Code...
              </Typography.Text>
            </div>
          ) : (
        ...
        <div
          className={`mt-5 flex flex-col items-center gap-1 qr-fade-in ${
            fadeIn ? "active" : ""
          }`}
        ...
        <div
          className={`mt-6 text-xs text-gray-400 text-center qr-fade-in ${
            fadeIn ? "active" : ""
          }`}
          style={{ transitionDelay: "0.4s" }}
        >
          Scan this QR code with your phone to open this card directly, or use
          an external scanner to get the URL
        </div>
      </div>
    </Modal>
  );
