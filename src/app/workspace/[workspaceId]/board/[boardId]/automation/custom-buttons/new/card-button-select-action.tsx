...
export function CardButtonSelectAction({
  ...
  const handleSaveAction = () => {
    if (selectedRule.actions && selectedRule.actions.length > 0) {
      ...
      if (editingActionIndex !== null) {
        ...
        configuredAction =
          selectedRule.actions.find(
            (action) => action.type && action.selectedActionItem?.type
      ...
      if (
        configuredAction &&
        configuredAction.selectedActionItem &&
        !configuredAction.selectedActionItem.id
      ) {
      ...
      if (editingActionIndex !== null) {
        ...
        if (
          ...
          configuredAction.selectedActionItem?.type
        ) {
