...
const SplitJobSlider: React.FC<SplitJobSliderProps> = ({
  ...
  const [activeTemplate, setActiveTemplate] = useState<SplitJobTemplate | null>(null);
        ...
        <div className="cursor-pointer">
          ...
          >
            <div className="p-1 rounded hover:bg-gray-100">
              <PartitionOutlined className={isCreating ? "text-blue-500" : "text-gray-500"} spin={isCreating} />
            </div>
          </SplitJobPopover>
        </div>
      </Tooltip>
